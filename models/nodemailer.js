...
function sendEmail(userEmail, subject, text) {
  ...
  const msg = {
    ...
    html: `${text} <br/> <br/> <img src="https://i.imgur.com/E4SBeVw.png" width="700px" height="auto"/> <br/> <br/> If you would like to stop recieving these emails, please go to <a>https://societly.netlify.app</a> and unsubscribe from your profile settings`,
  };
